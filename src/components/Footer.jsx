      ...
      <div className="max-w-screen-xl mx-auto pb-5 py-0 lg:py-14">
        <div className="px-3 md:px-5 lg:px-0 flex flex-col lg:flex-row gap-10 lg:gap-36">
          <div className="basis-1/2">
            <h1 className="-translate-x-1.5 text-[4rem] md:text-[6.5rem] lg:text-[12rem] leading-none tracking-tight font-medium">
              refokus.
            </h1>
          </div>
          ...
          <div className="basis-1/2 flex flex-col lg:flex-row gap-10 lg:gap-0">
            ...
            <div className="basis-1/3">
              ...
              {["Home", "Work", "Careers", "Contact"].map((link, index) => (
                <a
            ...
            <div className="basis-1/2 flex flex-col lg:items-end justify-end">
              <p className="w-[80%] md:w-[55%] lg:w-auto text-left lg:text-right font-medium text-lg lg:text-base">
                Refokus is a pioneering digital agency driven by design and
                empowered by technology.
              </p>
              <img
                className="mt-4 lg:mt-6 w-32 md:w-40"
        ...
        <div className="mt-10 lg:mt-16 px-3 flex flex-wrap gap-6 md:gap-10">
