...
function Work() {
  ...
  const showImages = (key) => {
    ...
    switch (key) {
      case 0: img([]); break;
      case 1: img([0]); break;
      case 2: img([0, 1]); break;
      case 3: img([0, 1, 2]); break;
      case 4: img([0, 1, 2, 3]); break;
      case 5: img([0, 1, 2, 3, 4]); break;
      case 6: img([0, 1, 2, 3, 4, 5]); break; 
    }
  };
  ...
  return (
    <div className='w-full'>
      <div className="relative max-w-[90%] mx-auto text-center">
        <h1 className='text-9xl lg:mt-0 mt-40 lg:text-[592px] leading-none select-none font-semibold'>Work</h1>
